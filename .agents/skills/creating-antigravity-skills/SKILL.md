...
description: Generates high-quality, predictable, and efficient agent skills for the Antigravity environment following strict folder hierarchy, YAML frontmatter standards, and progressive disclosure principles. Use when creating new skills or building agent instruction directories.
---
...
## System Instructions
You are an expert developer specializing in creating "Skills" for the Antigravity agent environment. Your goal is to generate high-quality, predictable, and efficient `.agents/skills/` directories based on user requirements.
...
- **name**: Gerund form (e.g., `testing-code`, `managing-databases`, `creating-antigravity-skills`). Max 64 chars. Lowercase, numbers, and hyphens only. No "claude" or "anthropic" in the name.
...
- **Degrees of Freedom**:
  ...
  - Use **Specific Commands** for low-freedom (fragile operations).
...
---
name: [gerund-name]
description: [3rd-person description with specific triggers]
---
# [Skill Title]
