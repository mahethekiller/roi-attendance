    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-2 text-xs text-base-content/60 mb-2 font-medium">
                ...
                <span>/</span>
                <span class="text-base-content">Edit Override Rule</span>
            </div>
            <div class="flex items-center justify-between flex-wrap gap-2">
                <div>
                    <h2 class="text-2xl sm:text-3xl font-bold text-base-content tracking-tight">Edit Override Rule</h2>
                    <p class="text-sm text-base-content/70 mt-1">
                        Editing rule for <strong class="text-base-content">{{ $attendanceOverride->employee_name ?: ($attendanceOverride->employee_id ?: $attendanceOverride->card_no) }}</strong>.
                    </p>
                </div>
                <form action="{{ route('admin.attendance-overrides.destroy', $attendanceOverride) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this override rule?');">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-sm btn-outline btn-error gap-1.5">
        ...
        <div class="card bg-base-100 border border-base-200 shadow-xs">
            <div class="card-body p-5 sm:p-6">
                <form action="{{ route('admin.attendance-overrides.update', $attendanceOverride) }}" method="POST" id="overrideForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6 pb-6 border-b border-base-200">
                            ...
                            <select id="employeePicker" class="select select-bordered select-sm w-full">
                                ...
                                @foreach($employees as $emp)
                                    <option value="{{ $emp->id }}" 
                                            ...
                                            {{ ($attendanceOverride->card_no == $emp->card_no || $attendanceOverride->employee_id == $emp->employee_id) ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="form-control">
                                ...
                                <input type="text" name="employee_id" id="employee_id" value="{{ old('employee_id', $attendanceOverride->employee_id) }}" class="input input-sm input-bordered font-mono w-full" placeholder="I2K2-0340" />
                            </div>
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" name="card_no" id="card_no" value="{{ old('card_no', $attendanceOverride->card_no) }}" class="input input-sm input-bordered font-mono w-full" placeholder="1234" />
                            </div>
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" name="employee_name" id="employee_name" value="{{ old('employee_name', $attendanceOverride->employee_name) }}" class="input input-sm input-bordered w-full" placeholder="Employee Full Name" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6 pb-6 border-b border-base-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div class="form-control">
                                ...
                                <input type="time" step="1" name="check_in_window_start" id="check_in_window_start" value="{{ old('check_in_window_start', substr($attendanceOverride->check_in_window_start, 0, 8)) }}" required class="input input-sm input-bordered font-mono w-full" />
                            ...
                            <div class="form-control">
                                ...
                                <input type="time" step="1" name="check_in_window_end" id="check_in_window_end" value="{{ old('check_in_window_end', substr($attendanceOverride->check_in_window_end, 0, 8)) }}" required class="input input-sm input-bordered font-mono w-full" />
                        ...
                        <div class="p-3.5 rounded-xl bg-base-200/40 border border-base-200">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="form-control">
                                    ...
                                    <input type="number" min="0" max="59" name="adjusted_in_min_minute" id="adjusted_in_min_minute" value="{{ old('adjusted_in_min_minute', $attendanceOverride->adjusted_in_min_minute) }}" required class="input input-sm input-bordered font-mono w-full" />
                                ...
                                <div class="form-control">
                                    ...
                                    <input type="number" min="0" max="59" name="adjusted_in_max_minute" id="adjusted_in_max_minute" value="{{ old('adjusted_in_max_minute', $attendanceOverride->adjusted_in_max_minute) }}" required class="input input-sm input-bordered font-mono w-full" />
                    ...
                    <div class="mb-6 pb-6 border-b border-base-200">
                        ...
                        <div class="form-control max-w-sm">
                            ...
                            <div class="join w-full">
                                <input type="number" step="0.25" min="1" max="24" name="min_duration_hours" id="min_duration_hours" value="{{ old('min_duration_hours', $attendanceOverride->min_duration_hours) }}" required class="input input-sm input-bordered join-item font-mono w-full" />
                    ...
                    <div class="mb-6">
                        ...
                        <div class="form-control mb-4">
                            <label class="label cursor-pointer justify-start gap-3">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $attendanceOverride->is_active) ? 'checked' : '' }} class="checkbox checkbox-primary checkbox-sm" />
                                <span class="label-text font-semibold text-sm text-base-content">This override rule is active</span>
                            </label>
                        </div>
                        ...
                        <div class="form-control">
                            ...
                            <textarea name="notes" id="notes" rows="2" class="textarea textarea-bordered text-sm w-full" placeholder="Reason or memo for this override rule...">{{ old('notes', $attendanceOverride->notes) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-4 border-t border-base-200">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary flex items-center gap-2 shadow-xs">
                            ...
                            <span>Update Override Rule</span>
                        </button>
                    </div>
                </form>
            </div>
